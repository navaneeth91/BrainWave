  ...
  const enrollcourse = async () => {
    try {
      ...
      if (isAlreadyEnrolled) {
        ...
        toast.error("please visit the my enrollments page to access the course");
        return;
      }
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        {/* Left Section */}
        <div className="max-w-xl z-10 text-gray-600" data-aos="fade-right">
          <h1 className="md:text-course-details-heading-large text-text-course-details-heading-small font-semibold text-gray-800">
          ...
          {/* Rating */}
          <div className="flex items-center space-x-2 pt-3 pb-1 text-small" data-aos="fade-up">
          ...
          <p className="text-sm mt-2">
            Course by <span className="text-blue-600 underline">Navaneeth</span>
          </p>

          {/* Course Structure */}
          <div className="pt-8 text-gray-800" data-aos="fade-up">
          ...
          {/* Description */}
          <div className="py-20 text-sm md:text-default" data-aos="fade-up">
          ...
          <div className="p-5">
            ...
            <div className="pt-6" data-aos="fade-up">
              ...
              <ul className="ml-4 list-disc text-gray-600 text-sm md:text-default">
                ...
                <li>
                  Access to all course materials, including videos, quizzes, and
                  assignments.
                </li>
